...
pa       =        (p4 = 0 ? 1 : .15)         ; Select open or closed
ifreq1    =        540                     ; Tune
ifreq2    =        800                     ; Tune


aenv     expsega  .1, .0005, 30000, pa - .0005, .01   ; Percussive envelope
asqr1    oscil    1, ifreq1, 1, -1            
asqr2    oscil    1, ifreq1*1.4471, 1, -1     
asqr3    oscil    1, ifreq1*1.6170, 1, -1     
asqr4    oscil    1, ifreq1*1.9265, 1, -1     
asqr5    oscil    1, ifreq1*2.5028, 1, -1     
asqr6    oscil    1, ifreq1*2.6637, 1, -1     
