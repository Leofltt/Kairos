...
rvb i list fun = addPf' i 5 list fun
del i list fun = addPf' i 6 list fun
dur i list fun = addPf' i 3 list fun
freq i list fun = addPf' i 7 list fun    -- 303, hoover, karp
...
tune i list fun = addPf' i 8 list fun    -- hihat 808 tuning
rough i list fun = addPf' i 8 list fun   -- karp roughness (0 - 1)
stretch i list fun = addPf' i 9 list fun -- karp stretch (0 - 1)
