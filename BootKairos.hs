...
freq i list fun = addPf i 8 list fun    -- 303, hoover, karp, lpFM
cf i list fun = addPf i 9 list fun      -- 303, hoover, lpFM
res i list fun = addPf i 10 list fun     -- 303, hoover, lpFM
